...
Chain-of-Thought(CoT)는 LLM의 추론 능력을 크게 개선한 기법입니다. 복잡한 문제를 단계별로 쪼개어 해결하는 방식인데, Vision-Language Model(VLM)에서는 한계가 있었습니다.
...
CoVT는 VLM이 텍스트라는 이산적 상징의 한계를 넘어, 이미지의 물리적/공간적 특성을 시뮬레이션하며 추론하는 단계로 진화했음을 보여줍니다.

...
> 2023년 글을 2026년 9월에 보완했습니다. 원래 날짜 문자열로 파일명을 만들던 예제를, Nest의 의존성 주입과 크기·개수 제한을 사용하는 구성으로 바꿨습니다. 코드는 Express 어댑터와 `winston`·`nest-winston`을 사용하는 NestJS 애플리케이션을 가정합니다.
